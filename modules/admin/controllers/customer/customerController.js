...
const { getCustomerPurchasesPipeline } = require("./pipeline");
...
const getCustomerPurchases = async (req, res) => {
  try {
    ...
    const details = await Sales.aggregate(getCustomerPurchasesPipeline(customerId))

    console.log({ customerId, details })
